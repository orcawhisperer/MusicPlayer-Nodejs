...
jQuery(function($) {
    ...
    $.ajax({
        ...
        dataType: "json",
        //data: data,
        url: "http://localhost:3000/files/getFiles",
        success: function(data) {
            //alert('Get Success');
            tracks = data
        }
    });
    //console.log(json); //'use strict'
    ...
    if (supportsAudio) {
        ...
        var index = 0;
        playing = false;
        var mediaPath = 'file:///E:/MUSIC/Tamil/Vantha-Rajavathaan-Varuven/',
            extension = '',
            /* tracks = [{
                 "track": 1,
            ...
            buildPlaylist = $(tracks).each(function(key, value) {
                var trackNumber = value.trackNumber,
